...
export default function Profile() {
  ...
  const save = async (values) => { try { console.log('[BugSphere] Saving profile'); await api.put('/users/profile', { name: values.name, notificationsEnabled: values.notificationsEnabled }); toast.success('Profile saved') } catch (error) { console.error('[BugSphere] Profile save failed', error); toast.error('Could not save profile') } }
